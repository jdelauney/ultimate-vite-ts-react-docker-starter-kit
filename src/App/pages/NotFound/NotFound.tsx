  ...
  return (
    <section className={"section-notfound"}>
      <div className={'flex flex--center-all'}
           style={{"--mh": "60vh", "color": "var(--neutral-color-variation-3)"} as CSSProperties}>
        <SvgNotFound/>
      </div>
      <div className={'flex flex--center-all'}>
        <h1>Oooopss..</h1>
        <span>We are on earth, what are you doing here !?</span>
        <Link to={ROUTES.HOME} role={'button'} className={'btn--big btn--warning'}
              style={{'--px': '2em', '--mt': '1em'} as CSSProperties}>Back to Home</Link>
      </div>
    </section>
