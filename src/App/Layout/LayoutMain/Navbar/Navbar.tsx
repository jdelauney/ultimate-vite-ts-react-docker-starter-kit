    ...
    <div className="navigation navigation--fixed md:navigation-toggle">
      <nav aria-label="menu principal">
        ...
        <Link to={ROUTES.HOME} aria-label="back to home">
          ...
          <span className="navbar-title"><b>BRAND</b></span>
        </Link>
        <div id="main-menu" className="navbar__menu flex--center">
          <ul>
            <li>
              <Link to={ROUTES.HOME} aria-label="back to home">Accueil</Link>
            </li>

          </ul>
        </div>
        <label htmlFor="nav-toggle" className="navbar__toggler" aria-controls="navbar-menu"
               aria-label="Ouvre ou ferme le menu principal">
